...
//local real kpp_HS(real x, real k, real p);
...
global real mass(real eta)
{
    ...
    switch (model_int_flag){
        case HS: tmp=mass_HS(eta); break;
        case LCDM: tmp=mass_LCDM(eta); break;
    }
    return tmp;
}
...
global real JFL(real eta, real x, real k, real p)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=JFL_HS(eta, x, k, p); break;
        case LCDM: tmp=JFL_LCDM(eta, x, k, p); break;
    }
    return tmp;
}
*/
...
global real KFL(real eta, real k, real k1, real k2)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=KFL_HS(eta, k, k1, k2); break;
        case LCDM: tmp=KFL_LCDM(eta, k, k1, k2); break;
    }
    return tmp;
}
...
global real KFL2(real eta, real x, real k, real p)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=KFL2_HS(eta, x, k, p); break;
        case LCDM: tmp=KFL2_LCDM(eta, x, k, p); break;
    }
    return tmp;
}
*/
...
global real PiF(real eta, real k)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=PiF_HS(eta, k); break;
        case LCDM: tmp=PiF_LCDM(eta, k); break;
    }
    return tmp;
}
...
global real M1(real eta)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=M1_HS(eta); break;
        case LCDM: tmp=M1_LCDM(eta); break;
    }
    return tmp;
}
*/
...
global real M2(real eta)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=M2_HS(eta); break;
        case LCDM: tmp=M2_LCDM(eta); break;
    }
    return tmp;
}
...
global real M3(real eta)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=M3_HS(eta); break;
        case LCDM: tmp=M3_LCDM(eta); break;
    }
    return tmp;
}
*/
...
global real kpp(real x, real k, real p)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=kpp_HS(x, k, p); break;
        case LCDM: tmp=kpp_LCDM(x, k, p); break;
    }
    return tmp;
}
*/
...
global real S2a(real eta, real x, real k, real p)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=S2a_HS(eta, x, k, p); break;
        case LCDM: tmp=S2a_LCDM(eta, x, k, p); break;
    }
    return tmp;
}
*/
...
global real S2b(real eta, real x, real k, real p)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=S2b_HS(eta, x, k, p); break;
        case LCDM: tmp=S2b_LCDM(eta, x, k, p); break;
    }
    return tmp;
}
*/
...
global real S2FL(real eta, real x, real k, real p)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=S2FL_HS(eta, x, k, p); break;
        case LCDM: tmp=S2FL_LCDM(eta, x, k, p); break;
    }
    return tmp;
}
*/
...
global real S2dI(real eta, real x, real k, real p)
{
    real tmp;
    switch (model_int_flag){
        case HS: tmp=S2dI_HS(eta, x, k, p); break;
        case LCDM: tmp=S2dI_LCDM(eta, x, k, p); break;
    }
    return tmp;
}
*/
...
local real sourceFL_HS(real eta, real kf, real k1, real k2)
{
    ...
    Stmp = f1(eta)*(rsqr(mass_HS(eta))/PiF(eta,kf))*KFL(eta, kf, k1, k2);
                 ...
                 real Dpk, real Dpp, real D2f, real D2mf)
{
    ...
    t2 = (1.0/3.0)*(rpow(OmM(eta),3.0)*rpow(H(eta),4.0)/rpow(H02,4) )
        *(
            M3_HS(eta) - M2_HS(eta)*(M2(eta) + JFL_HS(eta,-1.0,p,p)*(3.0+2.0*cmd.omegaBD))
                        /(PiF_HS(eta,0))
...
local real sourceFL_LCDM(real eta, real kf, real k1, real k2)
{
    ...
    Stmp = f1(eta)*(rsqr(mass_LCDM(eta))/PiF(eta,kf))*KFL(eta, kf, k1, k2);
                   ...
                   real Dpk, real Dpp, real D2f, real D2mf)
{
    ...
    *(M2_LCDM(eta)/(PiF_LCDM(eta,k)*PiF_LCDM(eta,0)));
    ...
    t2 = (1.0/3.0)*(rpow(OmM(eta),3.0)*rpow(H(eta),4.0)/rpow(H02,4) )
    *(
      M3_LCDM(eta) - M2_LCDM(eta)*(M2(eta) + JFL_LCDM(eta,-1.0,p,p)*(3.0+2.0*cmd.omegaBD))
      /(PiF_LCDM(eta,0))
    ...
    *(
    ...
    t4 = (1.0/3.0)*(rpow(OmM(eta),3.0)*rpow(H(eta),4.0)/rpow(H02,4) )
    *(
      M3_LCDM(eta) - M2_LCDM(eta)*(M2(eta) + JFL_LCDM(eta,x,k,p)*(3.0+2.0*cmd.omegaBD))
      /(PiF_LCDM(eta,kplusp))
      ) / ( rsqr(PiF_LCDM(eta,p)) * PiF_LCDM(eta,k) );
